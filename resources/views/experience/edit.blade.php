...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Update Your Experience.') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('experience.update' , $experience) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="company_name" type="text" class="form-control @error('company_name') is-invalid @enderror" name="company_name" value="{{ $experience->company_name }}" required autocomplete="company_name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="job_title" type="job_title" class="form-control @error('job_title') is-invalid @enderror" name="job_title" value="{{ $experience->job_title }}" required autocomplete="job_title" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="achievement" type="text" class="form-control @error('achievement') is-invalid @enderror" name="achievement" value="{{ $experience->achievement}}" required autocomplete="achievement" autofocus>
